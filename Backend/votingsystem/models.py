...
class Candidate(TimestampedModel):
    ...
    campaign_video_data = models.BinaryField(blank=True, null=True)
    campaign_video_content_type = models.CharField(max_length=120, blank=True)
    campaign_video_filename = models.CharField(max_length=255, blank=True)
    photo = models.ImageField(upload_to="candidate_photos/", blank=True, null=True)
    photo_data = models.BinaryField(blank=True, null=True)
    photo_content_type = models.CharField(max_length=120, blank=True)
